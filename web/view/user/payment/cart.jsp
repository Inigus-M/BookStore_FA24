                ...
                <div class="row">
                    <div class="col-lg-8 col-md-6 col-12">
                        <div class="buttons-cart mb-30">
                            <form action="action">
                                <ul>
                                    <li><a href="http://localhost:8080/BookStore/home">Continue Shopping</a></li>
                                </ul>
                            </form>
                        </div>
                    </div>
                            ...
                            <table>
                                <tbody>
                                    <tr class="cart-subtotal">
                                        <th>Subtotal</th>
                                        <td>
                                            <span id="subtotal" class="amount">£999.999</span>
                                        </td>
                                    </tr>
                                    <tr class="shipping">
                                        <th>Shipping</th>
                                    ...
                                    <tr class="order-total">
                                        ...
                                        <td>
                                            <strong>
                                                <span id="totalCart" class="amount">£999.999</span>
                                            </strong>
                                        </td>
                                    </tr>
                                </tbody>
